...
class DistributionTests(unittest.TestCase):
    ...
    def test_platform_bootstraps_keep_verified_python_compatibility_core(self) -> None:
        ...
        self.assertIn("Invoke-AgentSkillsSourceNativeInstall", powershell)
        self.assertIn("AGENT_SKILLS_INSTALL_ENGINE_SELECTED = \"rust\"", powershell)
        self.assertIn("--offline", powershell)

...
```bash
python3 skills/apple-design-context-compiler/scripts/prepare_benchmark_case.py \
  skills/apple-design-context-compiler/references/benchmark-cases/au-create-project-alert/benchmark-case.json \
...
```bash
python3 skills/apple-design-context-compiler/scripts/create_ios_capture_runtime.py \
  --udid <simulator-udid> \
  ...
  --evaluator-dependency-generator skills/apple-design-context-compiler/scripts/unityframework_simulator_stub.py \
...
```bash
python3 skills/apple-design-context-compiler/scripts/create_benchmark_run_plan.py \
  skills/apple-design-context-compiler/references/benchmark-cases/au-create-project-alert/benchmark-case.json \
  --capture-adapter skills/apple-design-context-compiler/references/benchmark-cases/au-create-project-alert/capture_adapter.py \
  --capture-overlay skills/apple-design-context-compiler/references/benchmark-cases/au-create-project-alert/capture-overlay.patch \
  ...
  --reasoning high \
  --output skills/apple-design-context-compiler/references/benchmark-cases/au-create-project-alert/measured-run-plan.local.json
```

Then execute from the repository root with the generated `evidence_status: measured` plan:

```bash
python3 skills/apple-design-context-compiler/scripts/run_benchmark.py \
  skills/apple-design-context-compiler/references/benchmark-cases/au-create-project-alert/measured-run-plan.local.json \
  --workspace-root . \

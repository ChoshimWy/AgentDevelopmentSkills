...
def main() -> int:
    ...
    print("PASS apple-design-context-compiler self-test: schemas, Registry index, dependency closure, Agent Packet budget, Manifest handoff gate, isolated prepared real benchmark case, Codex provider receipt, pinned-checkout runner, validation config linkage, structured artifact chain, staged benchmark gains")
    return 0
